...
import { type BlockFrame, type SlidePhoto } from '@contentbuilder/shared';
  ...
  return (
    ...
    >
      ...
      {photos.map((p) => {
        ...
        /**
         * The box you drag is the whole story now. Ambient motion used to hold
         * at its far end, so a floating photo — which moves at the deepest
         * depth of all — finished well outside the frame you dragged, and this
         * overlay had to draw a second "where it settles" rectangle. Motion
         * lands at rest instead, so the frame IS the destination.
         */
        return (
          <div
            key={p.id}
