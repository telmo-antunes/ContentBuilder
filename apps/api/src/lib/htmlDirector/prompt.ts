...
- NEVER emit an empty element. If the brand's vocabulary has a marker/bullet class (tick, dot, bullet, mark), it must CONTAIN a character — a bullet, a dash, an arrow or a number. An empty marker renders as a gap where the reader expects a bullet.
